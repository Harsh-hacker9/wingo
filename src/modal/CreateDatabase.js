...
const CreateWingo = async(req, res) => {
    ...
    await connection.execute('TRUNCATE TABLE wingo');
...
const Create5D = async(req, res) => {
    ...
    // Reset DataBase 5D
    await connection.execute('TRUNCATE TABLE 5d');
...
const CreateK3 = async(req, res) => {
    ...
    // Reset DataBase K3
    await connection.execute('TRUNCATE TABLE k3');
...
const Level = async(req, res) => {
    ...
    await connection.execute('TRUNCATE TABLE level');
...
const NapRut = async(req, res) => {
    ...
    // Reset DataBase Level
    await connection.execute('TRUNCATE TABLE bank_recharge');
...
const Admin = async(req, res) => {
    ...
    // Reset DataBase Level
    await connection.execute('TRUNCATE TABLE admin');
    ...
    try {
        ...
        if (existingUser.length === 0) {
            ...
            await connection.execute(sql, [
                phone,                    // phone
                'AdminUser',             // name_user
                require('md5')(password), // password (hashed)
